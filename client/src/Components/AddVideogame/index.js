    ...
    return (
        <div className='form_outside'>
            ...
            <form className='form' onSubmit={handleSubmit}>
                ...
                <br />
                <input required type='text' name='name' value={body.name} className='inputs' onChange={handleInputChange} />
                <label>Rating:</label>
                <input type='number' name='rating' value={body.rating} step={0.01} max={5} min={0} className='inputs' onChange={handleInputChange} />
                <label>Plataforms:</label>
                <input required type='text' className='inputs' name='plataformas' placeholder='Xbox/ PC/ Playstation 5' value={body.plataformas} onChange={handleInputChange} />


                <label for="start">Fecha de lanzamiento:</label>

                <input type="date" id="start" name="lanzamiento" className='inputs' value={body.lanzamiento} min="2018-01-01" max="2021-12-31" onChange={handleInputChange} />

                <label>Description:</label>
                <input required type='text' name='description_raw' value={body.description_raw} className='inputs' onChange={handleInputChange} />
                <div>
                ...
                <button className='btnCrear'>CREAR VIDEOGAME</button>
            </form>
        </div>
    )
};
