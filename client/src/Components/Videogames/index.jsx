...
function ShowVideogames({ videogames, getVideogames }) {
    ...
    const pagination = (pageNumber) => {
        ...
        setEstado(pageNumber)
    }

    return (
        <div className='Videogames-pagination'>
            <div className='videogamesCard'>
                ...
                <div className='PaginationBlock'>
                    <Pagination postsPerPage={postsPerPage} totalPosts={videogames.length} paginate={pagination} estado={estado}/>
                </div>
